...
7. **[design/ui-wireframes.md](./design/ui-wireframes.md)** — Screen-by-screen wireframe descriptions and design language (Barbie-land palette). Companion visual artifact (lo-fi mockups of all 15 core screens, including the Styling Canvas and Dress Me shuffle) was published separately in the chat session.
